...
function messageBox(options, done, cancel) {
    ...
    if(options.confirm) {
        if(options.danger){
            var html = "\
            <button type='button' class='btn btn-danger' id='action'>Yes</button>\
            <button type='button' class='btn btn-secondary' id='close'>No</button>";
            dialog.find('.modal-footer').html(html);
        } else {
            var html = "\
            <button type='button' class='btn btn-primary' id='action'>Yes</button>\
            <button type='button' class='btn btn btn-light' id='close'>No</button>";
            dialog.find('.modal-footer').html(html);
        }
    } else {
        if(options.danger){
            var html = "\
            <button type='button' class='btn btn-danger' id='action'>Cancel</button>";
            dialog.find('.modal-footer').html(html);
        } else {
            var html = "\
            <button type='button' class='btn btn-success' id='action'>Cancel</button>";
            dialog.find('.modal-footer').html(html);
        }
    }
